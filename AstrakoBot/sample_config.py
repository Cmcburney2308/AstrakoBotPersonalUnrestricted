...
class Config(object):
    ...
    API_HASH = "spaceboys23"
    TOKEN = "BOT_TOKEN"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID =  7495309955 # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "spaceboys23"
    SUPPORT_CHAT = "spaceboys23"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1234567890123
